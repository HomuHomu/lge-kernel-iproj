...
static struct spi_board_info lge_bcast_msm_spi_board_info[] __initdata = {
	{
		.modalias	= "fc8101_spi",
		.mode		= SPI_MODE_0,
		.irq		= MSM_GPIO_TO_INT(33),	//DTV_INT_GPIO_NUM
		.bus_num	= 2,
		.chip_select	= 0,
		.max_speed_hz	= 24000000,	//set spi clock 24MHz from 10MHz(10000000) taew00k.kang 2011-08-30
...
static struct msm_i2c_platform_data msm_gsbi4_qup_i2c_pdata = {
	.clk_freq = 400000, // LGE_BSP_CAMERA::john.park@lge.com 2012-04-10  camera i2c clk speed increase to 400 Mhz 
	.src_clk_rate = 24000000,
	.msm_i2c_config_gpio = gsbi_qup_i2c_gpio_config,
};

#if defined(CONFIG_LGE_FUEL_GAUGE) || defined(CONFIG_LGE_SWITCHING_CHARGER_BQ24160_DOCOMO_ONLY)
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
	...
	RPM_LDO(PM8058_L21, 1, 1, 0, 1100000, 1100000, LDO150HMIN),
	RPM_LDO(PM8058_L22, 0, 1, 0, 1200000, 1200000, LDO300HMIN),
	RPM_LDO(PM8058_L23, 0, 1, 0, 1200000, 1200000, LDO300HMIN),
	RPM_LDO(PM8058_L24, 0, 1, 0, 0, 0, LDO150HMIN),
	RPM_LDO(PM8058_L25, 0, 1, 0, 0, 0, LDO150HMIN),
	...
	/*	 ID       a_on pd ss min_uV   max_uV   init_ip   freq */
	RPM_SMPS(PM8901_S2, 0, 1, 0, 0, 0, FTS_HMIN, 1p60),
...
static struct bq24160_platform_data bq24160_data __initdata = {
	...
	.inlimit_in = 0b1,		/* input limit for IN input : 0 => 1.5A, 1 => 2.5A */
	...
	.minsys_stat = 0b1,		/* minimum system voltage mode : 0 => not active, 1 => active */
	.dpm_stat = 0b1,		/* Vin-DPM mode : 0 => not active, 1 => active */
	.vindpm_usb = 0b100,	/* usb input Vin-dpm voltage : 000 => 4.2V */
	.vindpm_in = 0b100,		/* IN input Vin-dpm voltage */
...
/* [LGE_UPDATE_S: Charge this configuration only for NTT docomo because of H/W limitation] */
#if 0
static const unsigned int i_dcm_keymap[] = {
...
#endif
/* [LGE_UPDATE_E: Charge this configuration only for NTT docomo because of H/W limitation] */

static struct matrix_keymap_data i_dcm_keymap_data = {
	.keymap_size	= ARRAY_SIZE(i_dcm_keymap),
	.keymap		= i_dcm_keymap,
};

static struct pm8xxx_keypad_platform_data i_dcm_keypad_data = {
	.input_name		= "i_dcm-keypad",
	.input_phys_device	= "i_dcm-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
...
static struct othc_regulator_config othc_reg = {
	.regulator	 = "8058_l5",
/* LGE_CHANGE_S platform@lge.com H/W team asked to change 2850000 -> 2950000 */
...
static struct msm_board_data msm8x60_lge_i_board_data __initdata = {
	.gpiomux_cfgs = msm8x60_i_dcm_gpiomux_cfgs,
};
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
   ...
   lge_add_btpower_devices();
	...
	pm8058_platform_data.keypad_pdata = &i_dcm_keypad_data;
#endif
...
static void __init msm8x60_i_dcm_init(void)
{
	msm8x60_init(&msm8x60_lge_i_board_data);
}

static void __init msm8x60_i_dcm_init_early(void)
{
...
MACHINE_START(LGE_I_BOARD, "LGE I BOARD MSM8X60")
	...
	.init_machine = msm8x60_i_dcm_init,
	.timer = &msm_timer,
	.init_early = msm8x60_i_dcm_init_early,
MACHINE_END
